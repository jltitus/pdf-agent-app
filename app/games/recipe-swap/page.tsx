...
export const metadata = {
  title: 'Recipe card swap station — MFP Outreach',
}

// Self-contained browser at public/games/recipes/recipe-app.html (also offline).
// Embedded in the authenticated shell. /games is members-only (proxy.ts).
export default function RecipeSwapPage() {
  return (
    <main className="flex min-h-screen flex-col bg-[#f7f4ef]">
      <div className="flex items-center justify-between px-4 py-2">
        ...
        <a
          href="/games/recipes/recipe-app.html"
          target="_blank"
      ...
      <iframe
        src="/games/recipes/recipe-app.html"
