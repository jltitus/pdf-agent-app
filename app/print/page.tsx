  ...
  return (
    <div className="mx-auto max-w-3xl px-8 py-10 text-[#1a1a1a]">
      ...
      <header className="border-b-2 border-[#d73f09] pb-4">
        ...
        <h1 className="mt-1 text-xl font-bold">MFP Publication Reference System</h1>
      ...
      <footer className="mt-10 border-t border-gray-200 pt-4">
        <p className="text-[11px] leading-5 text-gray-400">
          This answer was generated by the MFP Publication Reference System using OSU Extension
